/** Publikt innehåll från noryva.se som MCP-verktygen exponerar. */
...
export const audience = {
  ...
  goodFit: [
    ...
    "Har kapacitet att ta emot fler kunder",
    "Vill fatta beslut baserat på data istället för gissningar",
  ],
};
